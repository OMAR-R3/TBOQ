...
<?php
    ...
    $registros = mysqli_query($conexion, "SELECT nombreAlumno,grado,grupo,turno,correo,fecha,hora,fecha2,hora2,fecha3,hora3,fecha4,hora4,fecha5,hora5,fecha6,hora6,r1,r2,r3,r4,r5,r6 from tboq_calificaciones where correo='$corr'") or die("Problemas en el select:" . mysqli_error($conexion));

    $consulta="SELECT * FROM tboq_calificaciones where correo='$corr'";
