<?php
        ...
        $conexion = mysqli_connect("localhost", "root", "", "tboq") or die("Problemas con la conexion");
            ...
            $registros = mysqli_query($conexion, "SELECT nombreAlumno,grado,grupo,turno,correo,fecha,hora,fecha2,hora2,fecha3,hora3,fecha4,hora4,fecha5,hora5,fecha6,hora6,r1,r2,r3,r4,r5,r6 from tboq_calificaciones where grado='$grad' AND grupo='$grup' and turno='$tur'") or die("Problemas en el select:" . mysqli_error($conexion));

            $consulta="SELECT * FROM tboq_calificaciones where grado='$grad' AND grupo='$grup' and turno='$tur'";
...
<br><br>
        ...
        <div class="par-1">
                    ...
                    <div class="siete">Calf Oseo</div>

                    <div class="cinco">Fecha Muscular</div>
         
                    <div class="siete">Calf Muscular</div>

                    <div class="cinco">Fecha Digestivo</div>
    
                    <div class="siete">Calf Digestivo</div>

                    <div class="cinco">Fecha Respiratorio</div>
  
                    <div class="siete">Calf Respiratorio</div>

                    <div class="cinco">Fecha Circulatorio</div>
      
                    <div class="siete">Calf Circulatorio</div>

                    <div class="cinco">Fecha Reproductivo</div>
                
                    <div class="siete">Calf Reproductivo</div>
        ...
        <div class="box-prom">
            <div class="promedio"><label>Promedio - Grupal: <?php echo $promes;?></label></div>
        </div>
